...
imgelon_bgr = face_recognition.load_image_file('images/elonmusk.jpg')
...
# lets test an image
test = face_recognition.load_image_file('images/elonmusk.jpg')
test = cv2.cvtColor(test, cv2.COLOR_BGR2RGB)
test_encode = face_recognition.face_encodings(test)[0]
print(face_recognition.compare_faces([train_elon_encodings],test_encode))

# lets test an image
test = face_recognition.load_image_file('images/Mary Kom.jpg')
test = cv2.cvtColor(test, cv2.COLOR_BGR2RGB)
test_encode = face_recognition.face_encodings(test)[0]
#print(face_recognition.compare_faces([train_elon_encodings],test_encode))
